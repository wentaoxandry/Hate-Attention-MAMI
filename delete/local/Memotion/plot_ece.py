...
if __name__ == '__main__':
    ...
    if modaltype == 'Unimodal':
        modals = ['Challenge-image-0', 'Challenge-image-1', 'Challenge-text-0', 'Challenge-text-1', 'memotion_image', 'memotion_text']
    else:
        ...
        for task in ['taskA', 'taskC']:
            if task == "taskA":
                ...
                for cate in os.listdir(os.path.join(modaldir, 'taskC')):
                    ...
                    reliability_diagram(labelB, predB, confidenceB, savedir, modal + '-task B-' + cate)    
                    reliability_diagram(labelC, predC, confidenceC, savedir, modal + '-task C-' + cate)    
