...
if __name__ == '__main__':
    ...
    with open(os.path.join(sourcedir, 'test.json'), encoding="utf8") as json_file:
    ...
    # Display the plot
    #plt.show()
    plt.savefig(os.path.join(datadir, 'cv_test_taskB.pdf'), bbox_inches='tight')
