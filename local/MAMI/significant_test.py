...
if __name__ == '__main__':
    ...
    if modaltype == 'Unimodal':
        modals = ['BERTC', 'GCAN', 'mami_text', 'ViT']
        refmodaldir = os.path.join(resultsdir, modaltype, 'mami_image')
        refname = 'mami_image'
        ...
        refmodaldir = os.path.join(resultsdir, modaltype, 'Hate-Attention-config1')
        refname = 'Hate-Attention-config1'
        resultsA1 = get_data(refmodaldir, 'taskA')
        resultsB1 = get_data(refmodaldir, 'taskB')
